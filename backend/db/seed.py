...
DEFAULT_SHOP_ITEMS = [
    ...
    {
        "name": "Forest Canopy",
        "description": "Recolors the app in deep greens.",
        "item_type": ShopItemTypeEnum.theme,
        "cost": 60,
        "image_url": "/shop-placeholders/theme-3.svg",
        "theme_key": "forest",
    },
    {
        "name": "Galaxy Drift",
        "description": "Recolors the app in cosmic indigo.",
        "item_type": ShopItemTypeEnum.theme,
        "cost": 60,
        "image_url": "/shop-placeholders/theme-4.svg",
        "theme_key": "galaxy",
    },
    {
        "name": "Candy Pop",
        "description": "Recolors the app in sweet pinks.",
        "item_type": ShopItemTypeEnum.theme,
        "cost": 60,
        "image_url": "/shop-placeholders/theme-5.svg",
        "theme_key": "candy",
    },
    {
        "name": "Retro Wave",
        "description": "Recolors the app in neon magenta.",
        "item_type": ShopItemTypeEnum.theme,
        "cost": 60,
        "image_url": "/shop-placeholders/theme-6.svg",
        "theme_key": "retro",
    },
    {
        "name": "Slate Mode",
        "description": "Recolors the app in cool grays.",
        "item_type": ShopItemTypeEnum.theme,
        "cost": 60,
        "image_url": "/shop-placeholders/theme-7.svg",
        "theme_key": "slate",
    },
    {
        "name": "Autumn Harvest",
        "description": "Recolors the app in amber and rust.",
        "item_type": ShopItemTypeEnum.theme,
        "cost": 60,
        "image_url": "/shop-placeholders/theme-8.svg",
        "theme_key": "autumn",
    },
]
